...
function buildSystemPrompt(policyContext) {
  return [
    ...
    "When the user's question is NOT covered by the data, still answer helpfully using your general knowledge about Irish tourism, travel tips, and the Wild Atlantic Way region.",
