...
function buildSystemPrompt(policyContext) {
  return [
    ...
    "Important notes about pricing in the tour database: ACT017 (Aran Islands Sunset Boat Cruise) has a price of EUR 4,870,233 and ACT021 (Wild Atlantic Way Coach & Cliffs Day) has a price of EUR 999,999. Do NOT automatically correct these prices or pretend they are normal. If the user asks about them directly, you may note that the pricing appears inconsistent and suggest they confirm with the company by calling +353 86 229 3331 or emailing info@atlanticcoasttours.ie.",
